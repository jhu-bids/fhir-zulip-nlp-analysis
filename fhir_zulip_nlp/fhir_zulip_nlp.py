...
def run(analyze_only=False, plots_only=False, analytical_tables_only=False, use_cached_keyword_inputs=False):
    """Run program"""
    if not analytical_tables_only and not plots_only:
        # Get inputs
        ...
        # Create reports
        # TODO: Performance: users (and maybe thread_length?) too slow. Once faster, remove `analytical_tables_only` arg
